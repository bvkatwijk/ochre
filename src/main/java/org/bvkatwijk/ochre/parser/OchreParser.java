...
@BuildParseTree
public class OchreParser extends BaseParser<Object> {
	...
	Rule Statement() {
		return FirstOf(
				Block(),
				Sequence(fromKeyword(Keyword.ASSERT), Expression(), Optional(COLON, Expression()), SEMI),
	...
	Rule fromKeyword(Keyword keyword) {
		return Keyword(keyword.getString());
	}
